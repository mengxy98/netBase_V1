...
// 从url直接获取参数集合
Main.fun.getRequestParams = function(){
	var params = Main.fun.params2Json(window.location.search.replace(/^\?/,''));
	return params;
};

//从url直接获取参数
Main.fun.getRequestParam = function(paramName){
	return Main.fun.getRequestParams()[paramName];
};