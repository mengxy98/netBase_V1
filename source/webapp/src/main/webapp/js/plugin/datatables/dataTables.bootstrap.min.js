...
$.extend(!0, $.fn.dataTable.defaults, {
    ...
    "oLanguage": {
        "sLengthMenu": "_MENU_",
        "sSearch": "",
        "sInfo": "显示 <span class='txt-color-darken'>_START_</span> 到 <span class='txt-color-darken'>_END_</span> 条，共 <span class='text-primary'>_TOTAL_</span> 条",
        "sInfoEmpty": "<span class='text-danger'>显示 0 到 0 条，共 0 条</span>",
	...
	//var flag=true;
        ...
        l = function (b, d) {
            var m, n, o, p, q = function (a) {
            	...
            	if(a.data.action=='jump'){
            		var num = $("#jumpNum").val();
	  	            if(typeof(num)=='undefined' || num.trim()==""){
	  	            	  return false;
	  	            }
            	};
            ...
            if (p = d[m], $.isArray(p)) l(b, p);
                ...
                case "jump":
                    ...
                    break;
                /*case "sinput":
                    g = "<input id='jumpNum' type='text' />", p="";
                    break;*/
                default:
                    g = p + 1, h = e === p ? "active" : ""
                }
                if(p=="jump"){
           	     g && (o = $("<li>", {
           	         ...
           	         "href": "#"
           	       }).html(g+"<input id='jumpNum' value='' style='height:16px;width:35px;margin:0px 1px;' />")).appendTo(b)),
           	           a.oApi._fnBindAction(o, {
              	        "action": p
            	      },
            	      q)
               }else{
           ...
           /* if(flag){
            	 $(b).after("<input id='jumpNum' style='height:26px;width:50px;border-radius: 2px;float:right; display: inline-block;margin: 3px 1px;' type='text' />"); 
            	 flag=false;
            	 $(b).attr("style","float:left;");
            }*/
