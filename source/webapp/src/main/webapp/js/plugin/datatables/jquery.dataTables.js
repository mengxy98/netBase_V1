(function (window, document, undefined) {
    (function (factory) {
        ...
        function _fnBuildAjax(oSettings, data, fn) {
            ...
            _fnCallbackFire(oSettings, 'aoPreXhr', 'preXhr', [oSettings, data]);
        ...
        DataTable = function (options) {
            ...
            this.each(function () {
                ...
                _fnCallbackReg(oSettings, 'aoPreXhr', oInit.fnPreXhr, 'user');
        ...
        $.each(['column', 'row', 'cell'], function (i, type) {
            _api_register(type + 's().every()', function (fn) {
                return this.iterator(type, function (settings, arg1, arg2, arg3, arg4) {
                    ...
                    //  arg4 - loop counter
                    fn.call(
                    new _Api(settings)[type](arg1, type === 'cell' ? arg2 : undefined), arg1, arg2, arg3, arg4);
                });
            });
        });
        ...
        $.extend(extPagination, {
            ...
            full_numbers: function (page, pages) {
                return ['first', 'previous', _numbers(page, pages), 'next', 'last','jump'];
            },
            ...
            pageButton: {
                _: function (settings, host, idx, buttons, page, pages) {
                    ...
                    var attach = function (container, buttons) {
                        ...
                        var clickHandler = function (e) {alert();
        ...
        // jQuery access
        $.fn.dataTable = DataTable; // Legacy aliases
