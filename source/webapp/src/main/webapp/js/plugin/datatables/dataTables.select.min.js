...
(function(j, u, i) {
    j = function(e, h) {
        ...
        function s(a) {
            ...
            c.on("mousedown.dtSelect", d,
            function(b) {
                if (b.shiftKey) c.css("-moz-user-select", "none").one("selectstart.dtSelect", d,
                function() {
                    return ! 1
                })
        ...
        function l(a, c, b, d) {
            if (!d || a.flatten().length) b.unshift(a),
            e(a.table().node()).triggerHandler(c + ".dt", b)
        }
        function t(a) {
            var c = a.settings()[0];
        ...
        function(a, c) {
            h.ext.selector[c.type].push(function(b, a, g) {
                ...
                if (a === i) return g;
                for (var k = 0,
                h = g.length; k < h; k++) e = b[c.prop][g[k]],
                (!0 === a && !0 === e._select_selected || !1 === a && !e._select_selected) && f.push(g[k]);
                return f
            })
        });
        h.ext.selector.cell.push(function(a, c, b) {
            ...
            if (c === i) return b;
            for (var e = 0,
            f = b.length; e < f; e++) d = a.aoData[b[e].row],
            (!0 === c && d._selected_cells && !0 === d._selected_cells[b[e].column] || !1 === c && (!d._selected_cells || !d._selected_cells[b[e].column])) && g.push(b[e]);
            return g
        });
        ...
        m("select.blurable()",
        function(a) {
            return a === i ? this.context[0]._select.blurable: this.iterator("table",
            function(c) {
        ...
        m("select.info()",
        function(a) {
            return t === i ? this.context[0]._select.info: this.iterator("table",
            function(c) {
                c._select.info = a
            })
        });
        m("select.items()",
        function(a) {
            return a === i ? this.context[0]._select.items: this.iterator("table",
            function(c) {
                c._select.items = a;
        ...
        m("select.style()",
        function(a) {
            return a === i ? this.context[0]._select.style: this.iterator("table",
            function(c) {
                c._select.style = a;
                if (!c._select_init) {
                    var b = new h.Api(c);
                    ...
                    b.on("draw.dtSelect.dt select.dtSelect.dt deselect.dtSelect.dt",
                    function() {
                        t(b)
                    });
        ...
        m("select.selector()",
        function(a) {
            return a === i ? this.context[0]._select.selector: this.iterator("table",
            function(c) {
                j(new h.Api(c));
        ...
        n("columns().deselect()", "column().deselect()",
        function() {
            var a = this;
            this.iterator("column",
            function(a, b) {
        ...
        n("cells().deselect()", "cell().deselect()",
        function() {
            var a = this;
            this.iterator("cell",
            function(a, b, d) {
