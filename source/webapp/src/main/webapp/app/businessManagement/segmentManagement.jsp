...
<div id="proDiolagAdd" style="z-index:100;display:none;position:fixed;width:100%;height:100%;top:0;left:0;background:rgba(0,0,0,0.5);">
	<div class="containerAdd1" style="background:#fff;width:50%;margin:7%  25% 2% 25%;padding-bottom:1%;height:65%;overflow:auto;">
		<div style="position: fixed;top: 0;left: 0;z-index:1000;width:50%;margin:7%  25%;background: #fff;border-bottom:1px solid #ddd;">
            	<p style="padding:1% 0 0 2%;height:2em;width:50%;float:left;font-size:1.3em;">添加标段信息</p>
		...
		<div id="contianerDetailAdd" style="width:90%;margin:8% auto;padding-top:2em;">
			...
			<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:15%;text-align:right">标段名称：</span>
						<input id="addSegName" style="float:left;width:52%" type="text" />
					</p>
				</li>
				<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:15%;text-align:right">父标段名称：</span>
						<select style="float:left;width:52%" id="addParentSegName">
						</select>
					</p>
				</li>
				<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:15%;text-align:right">起始桩号：</span>
						<input id="addSegStart" style="float:left;width:52%" type="text" />
					</p>
				</li>
				<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:15%;text-align:right">结束桩号：</span>
						<input id="addSegEnd" style="float:left;width:52%" type="text" />
					</p>
				</li>
				<li style="min-height:25px;margin-bottom:10px">
					<div style="overflow:hidden;width:100%;">
						<span style="float:left;width:15%;text-align:right">承包人：</span>
						<input style="float:left;width:52%" id="addSegContractor" value=""/>
					</div>
				</li>
				<li style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:15%;text-align:right">承包人描述：</span>
						<textarea style="float:left;width:52%;overflow:hidden;min-height:60px" id="addSegContractorDes"></textarea>
					</p>
				</li>
				<li>
					<p style="overflow:hidden;width:100%;">
