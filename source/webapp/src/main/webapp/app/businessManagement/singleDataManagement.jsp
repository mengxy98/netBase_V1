...
<body style="background: #fff;">
	...
	<script src="<%=request.getContextPath()%>/js/app/businessManage/singleDataManagement.js" type="text/javascript"></script>
	                                            ...
	                                            <table  id="datatable_col_reorder_roleManagement" class="table table-striped table-bordered table-hover">
	                                                <thead>
	                                             	 <tr>
		                                                 ...
		                                                 <th style="vertical-align: middle" data-hide="phone,tablet">层数</th>   
		                                                </tr>	                                                
	                                                </thead>
	                                                <tbody>
	...
	<div class="containerAdd1" style="background:#fff;width:50%;margin:7%  25% 2% 25%;padding-bottom:1%;height:65%;overflow:auto;">
		...
		<div id="contianerDetailAdd" style="width:90%;margin:8% auto;padding-top:2em;">
			<ul>
				...
				<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:18%;text-align:right">厚度：</span>
						<input id="thickness" style="float:left;width:52%" type="text" />
					</p>
				</li>
				<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:18%;text-align:right">遍数：</span>
						<input id="times" style="float:left;width:52%" type="text" />
					</p>
				</li>
				<li  style="min-height:25px;margin-bottom:10px">
					<p style="overflow:hidden;width:100%;">
						<span style="float:left;width:18%;text-align:right">层数：</span>
						<input id="divNum" style="float:left;width:52%" type="text" />
					</p>
				</li>
