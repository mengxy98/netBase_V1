...
/**
 * 继承jcaptcha中的GenericManageableCaptchaService，用于生成验证码，
 * 重写了validateResponseForID方法，加上了removeCaptcha方法，用于避免产生
 * “Invalid ID, could not validate unexisting or already validated captcha”的异常
 * @author zll
 *
 */
@Service
