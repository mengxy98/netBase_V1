...
/**
 * 模块名称: 类名称： ReflectionUtil 类描述： 创建人： 创建时间：2009-11-27 下午03:20:30 修改人：
 * 修改时间：2009-11-27 下午03:20:30 修改备注：
 * 
 * @version
 * 
 */
public class ReflectionUtil {
	 ...
	 */
	public static Object execGetMethod(Object obj, String parameter)
			throws IllegalArgumentException, SecurityException,
			IllegalAccessException, InvocationTargetException,
			NoSuchMethodException {
		if (parameter.indexOf(".") == -1)
			return findGetMethod(obj.getClass(), parameter).invoke(obj,
					new Object[0]);
		else
			return execGetMethod(
					execGetMethod(obj,
	 ...
	 * @throws Exception
	 */
	public static <T> T execSetMethod(T t, String parameter, Object objs)
			throws Exception {
		if (parameter.indexOf(".") == -1) {
			Class type = findFieldType(t.getClass(), parameter);
			findSetMethod(t.getClass(), parameter).invoke(t,
					TypeUtil.changeType(objs, type));
			return t;
		} else {
			Object field = execGetMethod(t,
					parameter.substring(0, parameter.indexOf(".")));
			if (field == null)
				field = findFieldType(t.getClass(),
						parameter.substring(0, parameter.indexOf(".")))
						.newInstance();
			return execSetMethod(
					t,
					parameter.substring(0, parameter.indexOf(".")),
					execSetMethod(field,
							parameter.substring(parameter.indexOf(".") + 1),
	 ...
	 * @throws NoSuchMethodException
	 */
	public static <T> Method findGetMethod(Class<T> clas, String parameter)
	 ...
	 * @throws NoSuchMethodException
	 */
	public static <T> Method findSetMethod(Class<T> clas, String parameter)
	 ...
	 * @throws NoSuchFieldException
	 */
	public static Class findFieldType(Class<?> clas, String fieldName)
			throws SecurityException, NoSuchFieldException {
	...
	public static String mehtod2Parameter(String method) {
		if (method.indexOf("get") == -1 && method.indexOf("set") == -1)
			return "";
		return new StringBuffer((char) (method.charAt(3) + 32) + "").append(
				method.substring(4)).toString();
	}
	...
	public static String getGet(String parameter) {
		return new StringBuffer("get")
				.append(parameter.toUpperCase().charAt(0))
				.append(parameter.substring(1)).toString();
	}
